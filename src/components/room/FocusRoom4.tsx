    ...
    <div className="card bg-base-100 shadow-md border-2 p-6 w-full mx-auto h-full">
      <div className="flex flex-col justify-between h-full w-full gap-15 py-2">
        ...
        <div className="flex justify-between items-center w-full gap-1">
          ...
          <div className="flex items-center gap-1 2xl:gap-20">
        ...
        <div className="flex flex-col gap-1 w-full">
          <div className="flex justify-between 2xl:justify-start items-center w-full gap-1 2xl:gap-24">
        ...
        {/* 3. 하단 열 */}
        <div className="flex justify-between 2xl:justify-start items-center w-full gap-1 2xl:gap-20">
